...
//=================================================================================================================================================
{
	if (ProvCMD_Counter < ProvCMD_Period){	ProvCMD_Counter++;		}									// системный таймер настроен на период 0.1с. С полупериодом 0.1 * ProvCMD_Period
	else				{	ProvCMD_Counter=0; ProvCMD_Value = !ProvCMD_Value;}								// меняем состояние переменной ProvCMD_Value. В функции, посвященной формированию проводных команд мигаем (если нет запрета) с этим периодом
...
// З А П Р Е Т   Р А З Р Я Д А ...........................................................
	if (AB1 < 72)	{													// Напряжение АБ < 72в AB1
			zr = 1;	}	
	else
		if (AB1 > 88)													
			zr = 0;					
...
//PE3 - запрет разряда
	...
	if(zz) //если запрет заряда
		MDR_PORTE->RXTX &= 0xfffb;		// PE2=0
	else
	{			
		if (ProvCMD_Value)
